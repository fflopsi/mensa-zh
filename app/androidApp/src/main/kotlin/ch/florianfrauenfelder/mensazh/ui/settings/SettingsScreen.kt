...
fun SettingsScreen(
  ...
  Scaffold(
    ...
    ListSelectorDialog(
      ...
      getTitle = { it.title },
      icon = R.drawable.ic_edit_location_24,
    ...
    ListSelectorDialog(
      ...
      getId = { it.id.toString() },
      getTitle = { it.title },
      icon = R.drawable.ic_hotel_class_24,
    ...
    ListSelectorDialog(
      ...
      getId = { it.id.toString() },
      getTitle = { it.title },
      icon = R.drawable.ic_filter_list_off_24,
    ...
    ListSelectorDialog(
      ...
      icon = R.drawable.ic_no_meals_24,
    ...
    LazyColumn(
      ...
      item(key = 4) {
        SettingsRow(
          ...
          Icon(painterResource(R.drawable.ic_arrow_next_24), null)
        }
      }
      item(key = 5) {
        SettingsRow(
      ...
      if (showMoreSettings) {
        item(key = 18) {
          ...
          SettingsRow(
            ...
            Box {
              Icon(painterResource(R.drawable.ic_more_vert_24), null)
              DropdownMenu(
                ...
                DropdownMenuItem(
                  ...
                  leadingIcon = { Icon(painterResource(R.drawable.ic_brightness_auto_24), null) },
                  trailingIcon = {
                    if (theme.theme == Theme.Auto) {
                      Icon(painterResource(R.drawable.ic_check_24), stringResource(R.string.active))
                    }
                  },
                )
                HorizontalDivider()
                DropdownMenuItem(
                  ...
                  leadingIcon = { Icon(painterResource(R.drawable.ic_light_mode_24), null) },
                  trailingIcon = {
                ...
                DropdownMenuItem(
                  ...
                  leadingIcon = { Icon(painterResource(R.drawable.ic_dark_mode_24), null) },
                  trailingIcon = {
