  ...
  Row(
    ...
    IconButton(onClick = toggleIsFavoriteMensa) {
      AnimatedContent(targetState = mensa.favorite) {
        if (it) {
          Icon(painterResource(R.drawable.ic_star_filled_24), stringResource(R.string.unfavorite))
        } else {
          Icon(painterResource(R.drawable.ic_star_24), stringResource(R.string.favorite))
        }
      }
    }
    IconButton(onClick = hideMensa) {
      Icon(painterResource(R.drawable.ic_visibility_off_24), stringResource(R.string.hide))
    }
  }
  Surface(
    modifier = Modifier
